...
## 附：SGLang GLM5Next 的 DSA CP 实现

SGLang GLM5Next 的 DSA indexer 明确走 global-K 路线，属于 Partial Q + Full KV/indexer 的 Mode 1 baseline：
...
topk/indexer 必须基于全局 K，否则不同 rank 会选择局部 topk，最终 attention 语义错误。
